...
set :repository,  "https://github.com/amolkhanorkar-webonise/Rails/tree/develop/Rails_Demo_Assignment2/demo_app"
set :scm, :git
#set :user, "webonise"  # The server's user for deploys
#set :scm_passphrase, "webonise6186"  # The deploy user's password
